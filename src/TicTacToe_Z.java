...
public class TicTacToe_Z extends javax.swing.JFrame {
    ...
    private void winGame()
    {
        ...
        if(b15 == ("X") && b14 == ("X") && b11 == ("X"))
        {
         ...
         if(b3 == ("X") && b13 == ("X") && b15 == ("X"))
        {
            JOptionPane.showMessageDialog(this, "Player X wins! Yay! Please reset game.", "Tic Tac Toe", JOptionPane.INFORMATION_MESSAGE);
            xCount++;
            scoreGame();
            jButton3.setBackground(Color.pink);
        ...
        if(b1 == ("O") && b2 == ("O") && b3 == ("O"))
        {
            JOptionPane.showMessageDialog(this, "Player O wins! Please reset game. ", "Tic Tac Toe", JOptionPane.INFORMATION_MESSAGE);
            oCount++;
            scoreGame();
            jButton1.setBackground(Color.pink);
            jButton2.setBackground(Color.pink);
        ...
        if(b15 == ("O") && b14 == ("O") && b11 == ("O"))
        {
         ...
         if(b3 == ("O") && b13 == ("O") && b15 == ("O"))
        {
            JOptionPane.showMessageDialog(this, "Player o wins! Yay! Please reset game.", "Tic Tac Toe", JOptionPane.INFORMATION_MESSAGE);
            oCount++;
            scoreGame();
            jButton3.setBackground(Color.pink);
            jButton13.setBackground(Color.pink);
...
private JFrame frame; 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TicTacToe_Z.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
